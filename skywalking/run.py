...
def generate_config():
    ...
    server_num = request.json.get("serverNum", 4)  # 服务的数量
    server_ins_num = request.json.get("serverInsNum", 4)  # 每个服务的实例的数量
    server_endpoint_num = request.json.get("serverEndPointNum", 4)  # 每个实例端点的数量
    logging.debug({
